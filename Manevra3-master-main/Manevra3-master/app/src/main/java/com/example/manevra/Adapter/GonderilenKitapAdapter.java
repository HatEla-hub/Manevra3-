...
public class GonderilenKitapAdapter extends RecyclerView.Adapter<GonderilenKitapAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int viewType) {
        ...
        return new GonderilenKitapAdapter.ViewHolder(view);
    }
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        Glide.with(context).load(gonderi.getGonderilenKitapResmi()).into(holder.gonderiResmi);
        if (gonderi.getGonderilenKitapHakkinda().equals("")){
            holder.txtkitapHakkindaYazi.setVisibility(View.GONE);
        }
        else
        {
